    ...
    <div class="container-fluid">
        <div class="card bg-transparent border-0">
            <form action="{{ route('customers.store') }}" method="POST">
                ...
                <div class="card-header rounded bg-white border d-flex justify-content-between align-items-center">
                    <div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="phone"
                                            aria-describedby="phoneHelp" name="phone" value="{{ $customer->phone }}">
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-6 d-flex justify-content-center align-items-center">
                            <div class="text-center">
                                ...
                                <img width="200px" class="my-4 mx-auto d-block" src="{{ asset('img/products.svg') }}"
                                    alt="products">
                                <small>Create a new customer to associate order to them.</small>
                            </div>
